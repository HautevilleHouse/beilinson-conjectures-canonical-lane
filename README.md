...
Canonical Lane research workspace for a flagship problem in arithmetic geometry and motive theory:
proving the regulator and special-value package for motives through an admissible motivic closure architecture.

## Main Manuscript

- [paper/BEILINSON_CONJECTURES_PREPRINT.md](paper/BEILINSON_CONJECTURES_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `BEILINSON_CONJECTURES_PREPRINT.md`
...
1. Theorem chain first: read `paper/BEILINSON_CONJECTURES_PREPRINT.md`.
...
Current BEI runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/bei_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/bei_closure_guard.py`.
...
- Manuscript target: [paper/BEILINSON_CONJECTURES_PREPRINT.md](paper/BEILINSON_CONJECTURES_PREPRINT.md)
