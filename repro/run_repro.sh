...
mkdir -p .tmp/beilinson_conjectures
cp artifacts/stitch_constants.json .tmp/beilinson_conjectures/stitch_constants.json
cp artifacts/constants_registry.json .tmp/beilinson_conjectures/constants_registry.json
