...
mkdir -p .repro_tmp/beilinson_conjectures
cp artifacts/stitch_constants.json .repro_tmp/beilinson_conjectures/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/beilinson_conjectures/constants_registry.json
