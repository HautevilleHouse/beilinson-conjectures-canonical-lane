...
- `sigma_special_raw = special_floor_raw - euler_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `value_transfer_raw = c_value_raw * transfer_gain_raw - e_value_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_regulator`, `sigma_special`, `kappa_compact`, `rho_rigidity`, `value_transfer`, `sigma_star_can`
    ...
    3. `scripts/bei_closure_guard.py`
